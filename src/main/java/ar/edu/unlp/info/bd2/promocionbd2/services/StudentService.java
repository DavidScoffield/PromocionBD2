...
import ar.edu.unlp.info.bd2.promocionbd2.models.CourseModel;
import ar.edu.unlp.info.bd2.promocionbd2.models.StudentModel;
import ar.edu.unlp.info.bd2.promocionbd2.repositories.CourseRepository;
import ar.edu.unlp.info.bd2.promocionbd2.repositories.StudentRepository;
    ...
    public String updateResource(StudentModel studentModel) {
        if (studentRepository.existsByEmail(studentModel.getEmail())) { // Check for availability of resource by email
            ...
            try {
                ...
                // studentModel.getCourses().stream().forEach(c -> { //Traverse through the
                // studentModel to fetch all the courses
                // try {
                // Course course = courseRepository.findCourseByEmail(studentModel.getEmail());
                // //Read the courses from the database
